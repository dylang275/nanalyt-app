...
const ALL_PRODUCTS: Product[] = [
  ...
  { id: 5, name: 'Mag + Ashwagandha Tablets', sku: 'MAG-ASH-60', state: 'Researching', platforms: 'Meta · Shopify · TikTok', price: '$32.99', rev: '—', margin: '33.5%', score: 77, sentiment: 'Positive', adSat: 'Low', adCount: 6, findings: 1, spark: [50, 55, 60, 65, 70, 74, 77], sparkPos: true, imgIdx: 4 },
