...
const GRID_COLS = 'grid grid-cols-[80px_1fr_80px_100px_80px_80px_80px_110px_60px] items-center px-[22px] py-3'
...
const PRODUCTS: ProductDetail[] = [
  ...
  },
  {
    ...
    creatives: [
      {
        id: 'z1', format: 'STATIC',
        bg: 'linear-gradient(135deg, #DBEAFE, #1E3A8A)',
        name: 'Restful nights, sharper mornings',
        angle: 'Sleep quality · Static',
      ...
      },
      {
        ...
        name: 'Creator review walkthrough',
        angle: 'Sleep quality · UGC',
      ...
      },
      {
        ...
        name: 'Sleep quality landing page',
        angle: 'v1 · Sleep quality · PDP',
    ...
    creatives: [
      {
        ...
        name: 'Stress-sleep angle test',
        angle: 'Stress-Sleep · UGC',
  ...
  },
  {
    ...
    creatives: [
      {
        id: 'g1', format: 'UGC',
        bg: 'linear-gradient(135deg, #A7F3D0, #10B981)',
        name: 'Switched from pills to gummies',
        angle: 'Sleep-Anxiety Crossover · UGC',
      ...
      {
        id: 'g2', format: 'STATIC',
        bg: 'linear-gradient(135deg, #FDE68A, #65A30D)',
        name: 'Flavor-forward composition',
        angle: 'Lifestyle · Static',
        daysLive: '10d', spend: '$0.9k', roas: '4.2×', cvr: '2.9%', ctr: '1.3%',
        verdict: 'scaling',
      },
      {
        id: 'g3', format: 'VIDEO',
        bg: 'linear-gradient(135deg, #BBF7D0, #16A34A)',
      ...
      },
      {
        ...
        name: 'Hero-led gummies PDP',
        angle: 'v1 · Sleep-Anxiety · PDP',
    ...
    creatives: [
      {
        ...
        name: 'Tincture morning routine',
        angle: 'Sleep-Anxiety · UGC',
  ...
  },
  {
    ...
    creatives: [
      {
        id: 'p1', format: 'UGC',
        bg: 'linear-gradient(135deg, #FECDD3, #E11D48)',
        name: 'Gut-mind connection test',
        angle: 'Wellness · UGC',
      ...
      {
        id: 'p2', format: 'STATIC',
        bg: 'linear-gradient(135deg, #FEE2E2, #FB7185)',
        name: 'Bottle hero shot',
        angle: 'Wellness · Static',
...
function HeaderStatusPill({ a, p }: { a?: ActiveVerdict; p?: PipelineVerdict }) {
  if (a === 'performing') {
    return (
  ...
  if (a === 'stable') return <span className={`${HEADER_PILL} bg-[#F0F1F3] text-[#4B5563]`}>Stable</span>
  if (a === 'watch') return <span className={`${HEADER_PILL} bg-[#FEF3D7] text-[#92400E]`}>Watch</span>
  if (p === 'validated') return <span className={`${HEADER_PILL} bg-[#EAF3DE] text-[#27500A] tracking-[0.03em]`}>VALIDATED</span>
  if (p === 'testing') return <span className={`${HEADER_PILL} bg-[#F0F1F3] text-[#4B5563] tracking-[0.03em]`}>TESTING</span>
  if (p === 'wind-down') return <span className={`${HEADER_PILL} bg-[#FEF3D7] text-[#92400E] tracking-[0.03em]`}>WIND DOWN</span>
  if (p === 'killed') return <span className={`${HEADER_PILL} bg-[#FCEBEB] text-[#791F1F] tracking-[0.03em]`}>KILLED</span>
  return null
}
    ...
    <div className="font-sans">
      <div className="max-w-[1200px] mx-auto px-6 pt-5 pb-12">
          ...
          <div className="flex items-center gap-3.5 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <HeaderStatusPill a={product.activeVerdict} p={product.pipelineVerdict} />
              </div>
        ...
        <Card className="overflow-hidden">
          {/* Header row — 9 direct grid children */}
          <div className={`${GRID_COLS} border-b-[0.5px] border-[#F0F1F3]`}>
            <span />
          ...
          {product.creatives.map((row, i) => {
            ...
            return (
              <div
                key={row.id}
                className={`${GRID_COLS} ${last ? '' : 'border-b-[0.5px] border-[#F0F1F3]'} transition-colors hover:bg-[#fafafa]`}
              ...
              >
                ...
                <div className="pl-1 min-w-0">
                  <p className="m-0 flex items-baseline gap-1.5 flex-wrap">
                    ...
                    {row.winner && (
                      <span
                        className="text-[9px] font-medium tracking-[0.03em] text-white px-1.5 py-px rounded-[8px]"
