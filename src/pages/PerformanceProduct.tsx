...
const PRODUCTS: ProductDetail[] = [
  ...
  },
  {
    ...
    subline: 'In test · No PDP · 1 ad · last 30 days',
    spend: '$3.6k', roas: '2.1×', cvr: '1.4%',
    pipelineVerdict: 'validated',
    vsAvg: '+14%',
    kpis: [
      { label: 'Impressions', value: '142k', delta: '+3%', deltaSign: 'pos' },
      { label: 'CTR', value: '0.8%', delta: '+0.1', deltaSign: 'pos' },
      { label: 'ATCs', value: '248', delta: '+5%', deltaSign: 'pos' },
      { label: 'CPA', value: '$28.40', delta: '−$1.20', deltaSign: 'pos' },
    ],
    bars: [38, 40, 42, 44, 42, 46, 48, 46, 50, 52, 50, 54, 56, 54, 58, 60, 58, 62, 64, 62, 66, 68],
    roasLine: [1.7, 1.8, 1.8, 1.9, 1.9, 2.0, 1.9, 2.0, 2.0, 2.1, 2.0, 2.1, 2.0, 2.1, 2.0, 2.1, 2.1, 2.0, 2.1, 2.1, 2.0, 2.1],
    creatives: [
      { id: 'a1', format: 'UGC', bg: 'linear-gradient(140deg, #FDE68A, #D97706)', name: 'Stress-sleep angle test', angle: 'Stress-Sleep · UGC', daysLive: '12d', spend: '$3.6k', roas: '2.1×', cvr: '1.4%', ctr: '0.8%', verdict: 'scaling' },
    ],
  },
  {
