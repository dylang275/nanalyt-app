...
function TrendChart() {
  ...
  const prod = [
    { label: 'Mag Glycinate', value: '$18.4k/wk', delta: '+23%', pos: true, color: '#4f86c6', img: PROD_IMGS.mag, vals: pick('magRev') },
    ...
    <div className="pt-6 px-12 pb-[72px] flex flex-col gap-6 font-sans">
      ...
      <div className="grid grid-cols-[1.8fr_1fr] gap-5">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-surf rounded-[10px] shadow-lift p-4">
