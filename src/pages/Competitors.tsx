...
const COMPETING_PRODUCTS: ProductPick[] = [
  { id: 'goodbye-stress', name: 'Goodbye Stress Gummies', img: '/uploads/IMG_3476.jpg', imgBg: '#5fb8c4', competesWith: 'Magnesium Glycinate Complex', activeAds: 19, spendPct: '42%', angles: 4 },
  { id: 'sleep-gummies', name: 'Sleep Gummies', img: '/uploads/IMG_3474.jpg', imgBg: '#7c5cbf', competesWith: 'ZzzPlex Sleep Support', activeAds: 14, spendPct: '31%', angles: 3 },
]

const TOP_PRODUCTS: ProductPick[] = [
  { id: 'pms-care', name: 'PMS Care Gummies', img: '/uploads/IMG_3472.jpg', imgBg: '#d4547a', activeAds: 9, spendPct: '16%', angles: 2 },
  { id: 'probiotic', name: 'Big 10 Probiotic', img: '/uploads/Screenshot 2026-05-11 at 9.02.37 PM.png', imgBg: '#6ab87a', activeAds: 5, spendPct: '7%', angles: 2 },
  { id: 'energy-focus', name: 'Extra Strength Daily Energy', img: '/uploads/Screenshot 2026-05-11 at 9.01.38 PM.png', imgBg: '#e8b84b', activeAds: 4, spendPct: '4%', angles: 1 },
]
  ...
  return (
    <div className="font-sans flex flex-col gap-7">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          { label: comp.name.toUpperCase(), name: compProduct, detail: '$14 · 60 gummies · 3mg melatonin', img: '/uploads/IMG_3474.jpg', bg: '#7c5cbf' },
